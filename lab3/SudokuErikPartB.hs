...
printSudoku sud = do let s = showSudoku sud
                     putStrLn s

showSudoku :: Sudoku -> String
showSudoku (Sudoku m) = unlines $ map showRow m
     where
...
isOkay :: Sudoku -> Bool
isOkay sud = isSudoku sud && all isOkayBlock (blocks sud)
...
readAndSolve file = do s <- readSudoku file
                       let sud = solve s
                       case sud of Nothing -> putStrLn "(No solution)"
